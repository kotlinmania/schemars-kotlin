...
This is a Kotlin Multiplatform line-by-line transliteration port of [`GREsau/schemars`](https://github.com/GREsau/schemars).

**Original Project:** This port is based on [`GREsau/schemars`](https://github.com/GREsau/schemars). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `GREsau/schemars`

> The text below is reproduced and lightly edited from [`https://github.com/GREsau/schemars`](https://github.com/GREsau/schemars). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:schemars-kotlin:0.1.1")
}
```
...
This Kotlin port is distributed under the same MIT license as the upstream [`GREsau/schemars`](https://github.com/GREsau/schemars). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`GREsau/schemars`](https://github.com/GREsau/schemars) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
