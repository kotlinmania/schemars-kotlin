...
@HiddenFromObjC
fun Serializer.serializeNewtypeStruct(
    name: String,
...
fun Serializer.serializeTuple(len: Int): SerializeTuple = SerializeTuple(generator, ArrayList(len), title = "")

fun Serializer.serializeTupleStruct(
    name: String,
    len: Int,
): SerializeTuple {
...
fun Serializer.serializeMap(): SerializeMap = SerializeMap(generator, linkedMapOf(), currentKey = null, title = "")
