...
class TupleSchema(
    ...
    override fun schemaName(): String = "Tuple_of_" + elements.joinToString("_and_") { it.schemaName() }

    override fun schemaId(): String = "(" + elements.joinToString(",") { it.schemaId() } + ")"
