...
class ResultSchema(
    ...
    override fun schemaName(): String = "Result_of_${ok.schemaName()}_or_${err.schemaName()}"

    override fun schemaId(): String = "Result<${ok.schemaId()}, ${err.schemaId()}>"
...
class RangeInclusiveSchema(
    inner: JsonSchema,
) : JsonSchema by RangeSchema(inner)
