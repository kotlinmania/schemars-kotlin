...
This file is the quick-reference operating contract for schemars-kotlin. The longer
...
schemars-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`schemars`](https://crates.io/crates/schemars). Upstream Rust is the behavioral oracle while the
